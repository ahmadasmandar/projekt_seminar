classdef UIQRCode < matlab.apps.AppBase
    ...
    methods (Access = public)
        ...
        function qr_button_Callback(app, ~)
            ...
            try
                ...
                javaaddpath('core-340.jar');
                javaaddpath('javase-340.jar');
                text = decode_qr(img);
                if isempty(text)
                    color = 'red';
                    text = 'Nichts erkannt ...';
                ...
                app.TextLabel2.FontColor = color;
            catch e
        ...
        function app = enable_webcam(app, value)
            ...
            if ~is_webcam(app.init_app) || app.init_app.demo
                return;
            end
    ...
    methods (Access = public)
        ...
        function app = UIQRCode(UI, parent, id)
            ...
            img_webcam= imread("images/qr_code.png");
